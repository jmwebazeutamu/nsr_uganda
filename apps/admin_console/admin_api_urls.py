...
urlpatterns = [
    ...
    path("workflow/ddup/versions/<str:version_id>/submit/",
         ddup_version_submit, name="admin-workflow-ddup-version-submit"),
    path("workflow/ddup/versions/<str:version_id>/approve/",
         ddup_version_approve, name="admin-workflow-ddup-version-approve"),
