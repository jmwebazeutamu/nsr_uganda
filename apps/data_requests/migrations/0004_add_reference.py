"""Give every datarequest a case number: DRS-2026-0001.
...
sequence reads the way anyone would expect — the first datarequest of 2026
is DRS-2026-0001. The shared counter in
...
def backfill(apps, schema_editor):
    ...
    Model = apps.get_model("data_requests", "datarequest")
