...
| # | Screen | Anchored to | Filename in `/design/v0.1/screens/` |
|---|---|---|---|
| 1 | Parish operator household capture (desktop) | US-088, US-112 | `01_capture_desktop.html` |
| 1b | Parish operator household capture (CAPI tablet) | US-088, US-112 | `01_capture_capi.html` |
| 2 | Provisional Registry ID receipt slip | US-112 | `02_receipt_slip.html` |
| 2b | SMS preview | US-112 | `02_receipt_sms.html` |
| 3 | NSR Unit DIH review queue | US-109 | `03_dih_review_queue.html` |
| 4 | DIH ConnectorRun dashboard | US-107 | `04_connector_runs.html` |
| 5 | Dedup Operator side-by-side compare | US-083 | `05_dedup_compare.html` |
| 6 | UPD reviewer with PMT preview | US-090 | `06_upd_reviewer.html` |
| 7 | DRS Query Builder | US-097 | `07_drs_query_builder.html` |
| 7b | DRS Field Selector | US-098 | `07_drs_field_selector.html` |
| 7c | DRS Preview pane | US-098 | `07_drs_preview.html` |
| 7d | DRS Delivery method choice | US-099, US-100, US-101 | `07_drs_delivery.html` |
| 8 | DPO cumulative volume console | US-103 | `08_dpo_console.html` |
| 9 | Household detail (registry view) | US-005, US-090 | `09_household_detail.html` |
| 10 | Home dashboard (role-aware) | (general) | `10_home_<role>.html` |
...
1. All priority screens 1 through 7 have a corresponding HTML file in `/design/v0.1/screens/`.
